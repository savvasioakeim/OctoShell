...
export const KEY = {
  ...
  assistantSessions: "octoshell.assistant.sessions",
  orchestrator: "octoshell.orchestrator",
  watch: "octoshell.watch",
  agentsPanelH: "octoshell.agents.panelH",
  aiModel: "octoshell.ai.model",
  aiProfiles: "octoshell.ai.profiles",
  aiProfile: "octoshell.ai.profile",
  agentDefaults: "octoshell.defaults.agent",
  orchestratorDefaults: "octoshell.defaults.orchestrator",
  globalRules: "octoshell.settings.globalRules",
  spendLimit: "octoshell.settings.spendLimit",
  workspaceSettings: "octoshell.settings.workspace",
  appearanceSettings: "octoshell.settings.appearance",
  systemSettings: "octoshell.settings.system",
  sttEngine: "octoshell.settings.sttEngine",
  reviewAgent: "octoshell.settings.reviewAgent",
  ...
  strategyRoles: "octoshell.strategy.roles",
  onboardingDone: "octoshell.onboardingDone",
  agentCfgDir: (id: string) => `octoshell.cfgdir.${id}`,
  collapsed: "octoshell.collapsed",
